...
export const solutions = {
  SAD: [
    ...
    },
    {
      ...
      question: "혼났어요",
      solution:
        "강아지는 소리보다 손짓에 더 민감하므로 격한 제스처는 줄여주세요",
    },
    {
      id: "3",
      question: "차에 탔어요",
    ...
    },
    {
      ...
      solution:
        "목욕을 싫어하지 않도록 먼저 샴푸를 쓰지 않는 목욕을 목표로 도전해보세요",
    },
    {
      id: "5",
      question: "낯선 소리가 나거나 낯선 상황이었어요",
      solution:
        "교육(앉아, 기다려)이 필요하고 교육을 잘 받으면 보상으로 간식을 주세요",
    },
  ],
  HAPPY: [],
};
...
export const colorVariants = {
  ...
  shadowprimary: "shadow-primary-theme",
  shadowsecondary: "shadow-secondary-theme",
  shadowthird: "shadow-third-theme",
};

      ...
      <div class="relative mt-1">
        {selectedPet ? (
          <button
            ...
            type="button"
            class={`relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm  focus:${
              colorVariants["border" + themeMode]
            } ${
              colorVariants["ring" + themeMode]
              ...
              <li
                ...
                class={`${
                  pet?.petId === selectedPet?.petId
                    ? colorVariants["bg" + themeMode] + ` text-white`
                    : "text-gray-900"
              ...
              >
                ...
                <span
                  class={`${
                    ...
                    pet?.petId === selectedPet?.petId ? "absolute" : "hidden"
